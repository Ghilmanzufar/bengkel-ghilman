    ...
    return (
        ...
        <div className="flex flex-col items-center">
            ...
            <div className="mt-4 space-y-2 w-full text-center">
                <button className="flex items-center justify-center w-full bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700">
                    <FaHistory className="mr-2" /> Riwayat Pesanan
                </button>
                <button className="flex items-center justify-center w-full bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">
                    <FaMotorcycle className="mr-2" /> Riwayat Booking dan Servis
                </button>
                <button className="flex items-center justify-center w-full bg-gray-600 text-white px-4 py-2 rounded hover:bg-gray-700">
